...
Write-Host "";
Write-Host "";
Write-Host -ForegroundColor Blue " __   _   _ _  _   _   _   _  _ __   ___  _   _   _ ";  
Write-Host -ForegroundColor Blue "|  \ / \ | | || | / \ / \ / \/// _| | o )/ \ | \_/ |"; 
Write-Host -ForegroundColor Blue "| o ) o || V || |( o | o | o ) \_ \ | o \ o || \_/ |"; 
Write-Host -ForegroundColor Blue "|__/|_n_| \_/ |___\_/ \_/ \_/  |__/ |___/_n_||_| |_|"; 
Write-Host -ForegroundColor Blue "                                                    "; 
Write-Host "";
Write-Host -ForegroundColor Blue "   A simply fork of Red Lotus made by ItsDavloooDev" -NoNewLine
Write-Host -ForegroundColor Blue " discord.com/users/1208096916030627970";
Write-Host "";
